...
# Example usage
with open("./Datafiles/Timestamps_data.json", "r") as json_file:
    data_str = json_file.read()
data = json.loads(data_str)

start_datetime = "20211109100000"  # Enter the start datetime in YYYYMMDDHHMMSS format
end_datetime = "20211109120000"    # Enter the end datetime in YYYYMMDDHHMMSS format
target_id = "1001"                  # Enter the target ID (or set to None for all IDs)
